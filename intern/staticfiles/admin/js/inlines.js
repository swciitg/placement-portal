...
(function($) {
    ...
    $.fn.formset = function(opts) {
        ...
        var updateElementIndex = function(el, prefix, ndx) {
            ...
            var reintern = prefix + "-" + ndx;
            if ($(el).prop("for")) {
                $(el).prop("for", $(el).prop("for").replace(id_regex, reintern));
            }
            if (el.id) {
                el.id = el.id.replace(id_regex, reintern);
            }
            if (el.name) {
                el.name = el.name.replace(id_regex, reintern);
            }
        };
